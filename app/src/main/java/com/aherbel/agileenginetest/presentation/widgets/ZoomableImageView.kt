package com.aherbel.agileenginetest.presentation.widgets
...
class ZoomableImageView : AppCompatImageView, View.OnTouchListener,
    ...
    private fun fixTranslation() {
        ...
        val transX = mMatrixValues?.get(Matrix.MTRANS_X) ?: 0f //get the most recent translation in x direction
        val transY = mMatrixValues?.get(Matrix.MTRANS_Y) ?: 0f //get the most recent translation in y direction
